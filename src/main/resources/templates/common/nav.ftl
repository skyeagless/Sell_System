    ...
    <ul class="nav sidebar-nav">
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/sell/seller/product/modify">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">商品类别操作</li>
                <li><a href="/sell/seller/category/list">类别列表</a></li>
                <li><a href="/sell/seller/category/modify">新增</a></li>
            </ul>
        </li>
